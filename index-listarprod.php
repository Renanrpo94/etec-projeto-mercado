        ...
        <div class="container">
            <div class="row">
                <div class="col mt-5">
                    ...
                    <h2>Consulta de produtos</h2><br><br>
                    
                    <form action="controlecad.php" method="get">
                        
                        <div class="mb-3">
                            <label for="ordem"><h4>Ordem da consulta</h4></label><br>
                            <input type="radio" name="ordem" id="cod" value="c">Codigo do produto<br>
                            <input type="radio" name="ordem" id="nome" value="n">Nome do produto<br><br>
                        </div>
            
                        <input type="submit" value="Listar" name="listar" id="listar" class="btn btn-success">
                    </form>
                </div>
            </div>
        </div>
